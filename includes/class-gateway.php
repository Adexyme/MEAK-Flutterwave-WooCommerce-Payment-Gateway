...
class Meak_Flutterwave_Gateway extends WC_Payment_Gateway
{
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            ...
            'testmode' => array(
                ...
                'type' => 'checkbox',
                'description' => 'Tick this to enable sandbox/test mode. According to Flutterwave\'s documentaion, test Card details are: ',
                'default' => 'yes',
            ),
            'success_url' => array(
