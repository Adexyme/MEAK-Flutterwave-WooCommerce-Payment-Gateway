...
final class Meak_Flutterwave_Gateway_Blocks extends AbstractPaymentMethodType
{
    ...
    private $gateway;
    protected $name = 'meak_flutterwave_gateway';// your payment gateway name
    ...
    {
        $this->settings = get_option('woocommerce_meak_flutterwave_gateway_settings', []);
        $this->gateway = new Meak_Flutterwave_Gateway();
    }
    ...
    public function get_payment_method_script_handles()
    {
        ...
        if (function_exists('wp_set_script_translations')) {
            wp_set_script_translations('flutterwave-blocks-integration');

        }
        return ['flutterwave-blocks-integration'];
    }
